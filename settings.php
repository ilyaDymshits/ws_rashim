...
if ($hassiteconfig) {
	...
	$settings->add ( new admin_setting_configcheckbox ( 'local_ws_rashim/michlol_course_no_hide', get_string ( 'michlol_course_no_hide', 'local_ws_rashim' ), null, 0 ) );
	...
	$settings->add ( new admin_setting_heading ( 'local_ws_rashim/ktree', '<h2>' . get_string ( 'ktree', 'local_ws_rashim' ) . '</h2>', '' ) );
	
	$settings->add ( new admin_setting_configtext ( 'local_ws_rashim/ktree_root', get_string ( 'ktree_root', 'local_ws_rashim' ), NULL, NULL ) );
	
	$settings->add ( new admin_setting_configtext ( 'local_ws_rashim/ktree_latest_text', get_string ( 'ktree_latest_text', 'local_ws_rashim' ), NULL, get_string ( 'ktree_latest', 'local_ws_rashim' ) ) );
	
	$settings->add ( new admin_setting_configtext ( 'local_ws_rashim/ktree_exclude', get_string ( 'ktree_exclude', 'local_ws_rashim' ), NULL, 'forum,label' ) );
	
	$days = array_combine ( range ( 5, 30, 5 ), range ( 5, 30, 5 ) ) + array_combine ( range ( 45, 90, 15 ), range ( 45, 90, 15 ) );
	$days [0] = get_string ( 'ktree_no_age', 'local_ws_rashim' );
	
	$settings->add ( new admin_setting_configselect ( 'local_ws_rashim/ktree_age', get_string ( 'ktree_age', 'local_ws_rashim' ), null, '15', $days ) );
	...
	$ADMIN->add ( 'localplugins', new admin_externalpage ( 'local_ws_rashim_owerview', get_string ( 'overview_page', 'local_ws_rashim' ), new moodle_url ( '/local/ws_rashim/overview.php' ) ) );
}
